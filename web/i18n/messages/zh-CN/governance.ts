...
QualityChecker: {
    ...
    actions: {
      backendScanOn: '深度检测已开启',
      backendScanOff: '深度检测已关闭',
      backendScanLabel: '深度检测',
      backendScanDescription: '结合治理规则检查更多文档问题',
      scan: '重新检查',
      scanning: '正在检查 {progress}%',
    },
    score: {
      title: '数据质量评分',
      outOf: '/ 100',
      issueCount: '共 {count} 项检查结果',
      grades: {
        excellent: '优秀',
        good: '良好',
        pass: '及格',
    ...
    localIssues: {
      ...
      longParagraphs: '发现 {count} 处过长段落（超过 1,000 个字符），建议分段',
    ...
    backendIssues: {
      countSuffix: '（{count}）',
      detected: '深度检测发现：{message}',
      suggestedPatch: '有 {count} 项治理配置可以优化',
